...
class NeuroProccessor():
    def __init__(self, vectorizer_path="./lang_processors/tfidf_vectorizer.pkl", neuro_path="./lang_processors/neurolang_processor_model.pth"):
...
predicted_lang = neu_proc.predict_language(test_sentence)
