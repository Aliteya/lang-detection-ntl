...
class AlphabetProcessor:
    ...
    def create_profile_from_file(self, lang_name: str, file_path: str):
        try:
            ...
            print(f"ОШИБКА: Не удалось найти файл для языка '{lang_name}' по пути: {file_path}")
            return
        ...
        self.profiles[lang_name] = {letter: count/total_letters for letter, count in letter_counts.items()}
